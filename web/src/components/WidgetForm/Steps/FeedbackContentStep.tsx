    ...
    <>
      ...
      <form className="my-4 w-full">
        ...
        <footer className="flex items-center gap-2 mt-2">
          ...
          <button
            type="submit"
            className="p-[10px] bg-brand-500 rounded-[4px] border-transparent flex-1 flex justify-center items-center text-sm hover:bg-brand-300 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
